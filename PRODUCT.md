...
- **Constraints:** no payment processor; single gym, no multi-branch/multi-tenant; versioned ship process (currently v1.016) with a changelog; full test suite (250 tests incl. live-DB integration) must stay green.
