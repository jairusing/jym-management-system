...
- **Constraints:** no payment processor; single gym, no multi-branch/multi-tenant; versioned ship process (currently v1.013) with a changelog; full test suite (244 tests incl. live-DB integration) must stay green.
